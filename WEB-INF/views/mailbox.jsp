          ...
          <div class="box box-primary">
           ...
           <!--    <div class="box-tools pull-right">
                <div class="has-feedback">
                  <input type="text" id="id-search-user"class="form-control input-sm" placeholder="Search Mail">
                 <button  class="btn"></button>
                </div>
                
              </div> -->
              <div class="input-group box-width pull-right">
          <input type="text" name="q" id="id-search-user" class="form-control input-sm" placeholder="Search Mail">
...
<script src="${pageContext.request.contextPath}/resources/customjs/Inbox.js"></script> 