...
<header class="main-header">
    ...
    <a href="index.html" class="logo">
      ...
      <span class="logo-lg"><b class="text-uppercase">Riyad Banking</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="${pageContext.request.contextPath}/resources/images/user2-160x160.jpg" class="user-image" alt="User Image">
